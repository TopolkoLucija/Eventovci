...
\begin{packed_enum}
	...
	\begin{packed_enum}
		...
		\item vidjeti popis aktualnih događanja u odabranom vremenskom razdoblju (24 sata, 7 dana, 30 dana) te popis događanja koja su završila u posljednjih 48 sati
...
\begin{packed_item}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je trenutno prijavljen u sustav i otvoren je pregled osobnih podataka (\textbf{UC5})
		\item  \textbf{Opis osnovnog tijeka:}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je trenutno prijavljen u sustav, ima ovlasti Posjetitelja ili Organizatora i ima otvoren prikaz nekog događanja (\textbf{UC14})
		\item  \textbf{Opis osnovnog tijeka:}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je trenutno prijavljen u sustav, ima ovlasti Organizatora i prikazana su mu sva vlastita događanja (\textbf{UC16})
		\item  \textbf{Opis osnovnog tijeka:}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je prijavljen, ima ovlasti Organizatora i prikazana su mu sva vlastita događanja (\textbf{UC16})
		\item  \textbf{Opis osnovnog tijeka:}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je prijavljen, ima ovlasti Posjetitelja ili Organizatora i otvoren je prikaz jednog događanja (\textbf{UC14})
		\item  \textbf{Opis osnovnog tijeka:}
	...
	\begin{packed_item}
		...
		\item  \textbf{Sudionici:} Baza podataka
		\item  \textbf{Preduvjet:} Korisnik je prijavljen, ima ovlasti Administratora i otvoren je prikaz jednog događanja (\textbf{UC14})
		\item  \textbf{Opis osnovnog tijeka:}
