...
%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%
					...
					\noindent \underbar{\textbf{UC19 - Brisanje vlastite recenzije}}
					\begin{packed_item}
...
%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%
					...
					\noindent \underbar{\textbf{UC20 - Brisanje recenzije}}
					\begin{packed_item}
...
%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%	%
					...
					\noindent \underbar{\textbf{UC21 - Iskazivanje interesa za događanje}}
					\begin{packed_item}
