...
VALUES
    ('Event 1', 'Type 1', 'Location 1', CURRENT_TIMESTAMP, '02:50', 8, 15.0, 'opis'), -- Current time
    ('Event 2', 'Type 2', 'Location 2', TIMESTAMPADD(DAY, -1, CURRENT_TIMESTAMP), '02:30', 8, 20.0, 'opis'), -- Yesterday
    ('Event 3', 'Type 1', 'Location 3', TIMESTAMPADD(DAY, -3, CURRENT_TIMESTAMP), '01:00', 8, 10.0, 'opis'), -- 3 days ago
    ('Event 4', 'Type 3', 'Location 4', TIMESTAMPADD(HOUR, 3, CURRENT_TIMESTAMP), '04:00', 8, 25.0, 'opis'),  -- 3 hours from now
    ('Event 5', 'Type 2', 'Location 5', TIMESTAMPADD(DAY, 50, CURRENT_TIMESTAMP), '02:30', 9, 0, 'opis'),   -- 50 days from now
    ('Event 6', 'Type 1', 'Location 6', TIMESTAMPADD(DAY, 5, CURRENT_TIMESTAMP), '02:00', 9, 0, 'opis'),    -- 5 days from now
    ('Event 7', 'Type 3', 'Location 7', TIMESTAMPADD(DAY, 3, CURRENT_TIMESTAMP), '03:30', 9, 0, 'opis'),   -- 3 days from now
    ('Event 8', 'Type 2', 'Location 8', TIMESTAMPADD(HOUR, 12, CURRENT_TIMESTAMP), '01:45', 9, 0, 'opis'); -- 12 hours from now
